...
public class ConfigurationParameters {
	...
	// number of chunks into which a single partition has to be broken before loading into memory
	public static int numberOfPartitionChunks=1;
	// This is the absolute path to the root folder specific to the machine
	public static String ABSOLUTE_MACHINE_PATH  = "/cise/research/compneuro3/anik/version2/setup1/proc3/SensoryCoding/src/sensoryCoding/";
	//"C:/Users/crystalonix/Downloads/compNeuroScience/researchProj/sensoryCodingWithPreciseSpikeTime/SensoryCoding (2)/SensoryCoding/src/sensoryCoding/";
	...
	// for testing on a large corpora we set this to 0 because since we are applying stochastic gradient descent this removes all the local minima problems
	...
	public static final double OVERLAP_FACTOR = 1.0 / 3.0;
	...
	// number of partitions into which the entire data set has to be broken at processing stage
	...
	// Interval of number of steps after which we need to store the state of the network
